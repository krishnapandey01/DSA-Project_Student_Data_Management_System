...
void UpdateUsingStuID(struct Node *ahead)
{
    char key[10];
    struct Node *p;
    int choice = 0;
...
int main()
{
    ...
    S[1] = makeStudent("Oliver", "wood", 14, "45 aveneue street", "Manhatten", "Gujarat", "me@gmail.com", 8.8, 1234567899, "ECE");

    head = create(head, S, 2);
    S[2] = makeStudent("Ron", "whisley", 34, "45 aveneue street", "Manhatten", "Gujarat", "me@gmail.com", 5.8, 123456789, "ECE");

    // printf("After insertion: \n");

    S[3] = makeStudent("Micheal", "Jackson", 85, "45 aveneue street", "Manhatten", "Gujarat", "me@gmail.com", 7.8, 3232323, "CHE");
    S[4] = makeStudent("Charlie", "Whatson", 5, "45 aveneue street", "Manhatten", "Gujarat", "me@gmail.com", 9.8, 33237472, "ME");
    S[5] = makeStudent("Peter", "Parker", 25, "45 aveneue street", "Manhatten", "Gujarat", "me@gmail.com", 2.8, 332322, "ED");
    S[6] = makeStudent("Micheal", "Jackson", 85, "45 aveneue street", "Manhatten", "Gujarat", "me@gmail.com", 7.8, 332, "CHE");
